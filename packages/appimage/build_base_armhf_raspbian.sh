...
_app_image_build=https://github.com/AppImage/appimagetool/releases/download/1.9.0/appimagetool-armhf.AppImage
_app_image_build=https://github.com/AppImage/AppImageKit/releases/download/continuous/appimagetool-armhf.AppImage
